...
public class MainPageUITests extends TestBase {
    ...
    4. Новый репо
    4. Добавить интеграцию с аллюр тестопс
    5. Настроить в джобе отправку запусков в аллюр
    6. Переснять скриншоты для ридми
    7. Прогнать текст ридми через граммарли
     */
